          ...
          <CardContent className="flex items-center p-6">
            ...
            <div>
              ...
              <p className="text-xs text-green-600 flex items-center mt-1">
                <ArrowUpRight className="w-3 h-3 mr-1" /> {stats.totalTransactions} transactions
              </p>
            </div>
          </CardContent>
        </Card>
...
const DashboardApp = () => {
  ...
  const renderView = () => {
    switch (currentView) {
      ...
      case 'superadmin':
        if (role !== 'super_admin') return <div className="p-10 text-center text-red-500">Access Denied</div>;
